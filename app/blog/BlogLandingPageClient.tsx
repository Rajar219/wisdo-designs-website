...
interface BlogLandingPageClientProps {
  posts: BlogPost[];
}

export default function BlogLandingPageClient({ posts }: BlogLandingPageClientProps) {
  ...
  const featuredArticles = posts.filter((post) => post.featured).slice(0, 3);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="max-w-3xl mb-16 sm:mb-20 text-left border-l-4 border-indigo-600 pl-6 sm:pl-8">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-slate-500 leading-relaxed font-light max-w-2xl">
            Developer-driven tutorials, technical checklists, and systems engineering guides written by our core development team.
          </p>
        </div>
